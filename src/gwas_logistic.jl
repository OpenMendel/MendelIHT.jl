...
#     ω_top, ω_bot = _iht_omega_logistic(v)

#     μ_step = 0
#     while _logistic_backtrack2(v, ω_top, ω_bot, μ, μ_step, nstep)
...
#         #calculate the step size μ and check loglikelihood is not NaN or Inf
#         (μ, μ_step) = iht_logistic2!(v, x, z, y, J, k, glm, logl, temp_vec, mm_iter, max_step)
