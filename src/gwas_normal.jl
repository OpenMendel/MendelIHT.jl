...
function L0_normal_reg(
    ...
    for mm_iter = 1:max_iter
        ...
        (μ, μ_step) = iht_normal!(v, x, z, y, J, k, glm, logl, temp_vec, mm_iter, max_step)
...
"""
The code below is for running L0_nomal_reg where we backtrack whenever loglikelihood doesn't
decrease. This method performs slightly worse than the omega backtrack method. 
"""
function iht_normal2!(
    v         :: IHTVariable{T},
    x         :: SnpArray,
    z         :: Matrix{T},
    y         :: Vector{T},
...
function L0_normal_reg2(
    ...
    for mm_iter = 1:max_iter
        ...
        #calculate the step size μ.
        (μ, μ_step, next_logl) = iht_normal2!(v, x, z, y, J, k, glm, logl, temp_vec, mm_iter, max_step)
