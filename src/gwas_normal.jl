...
function iht_normal2!(
    ...
    μ_step = 0
    while _normal_backtrack2(v, ω_top, ω_bot, μ, μ_step, nstep)
...
function L0_normal_reg2(
    ...
    for mm_iter = 1:max_iter
        ...
        (μ, μ_step) = iht_normal2!(v, x, z, y, J, k, glm, logl, temp_vec, mm_iter, max_step)
...
function iht_normal!(
    ...
    # backtrack until mu < omega and until support stabilizes
    μ_step = 0
    while _normal_backtrack(new_logl, old_logl, μ_step, nstep)
